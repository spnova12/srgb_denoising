...
class Generator_one2many_gd_rir_new(nn.Module):
    def __init__(self, input_channel, numforrg=4, numofrdb=16, numofconv=8, numoffilters=64):
        ...
        self.rdb1 = RDB(self.numofkernels, nDenselayer=self.nDenselayer, growthRate=self.numofkernels)
        self.rdb2 = RDB(self.numofkernels, nDenselayer=self.nDenselayer, growthRate=self.numofkernels)
        self.rdb3 = RDB(self.numofkernels, nDenselayer=self.nDenselayer, growthRate=self.numofkernels)
        self.rdb4 = RDB(self.numofkernels, nDenselayer=self.nDenselayer, growthRate=self.numofkernels)
        self.oneone1 = nn.Conv2d(self.numofkernels * self.numforrg, self.numofkernels, kernel_size=1, stride=1, padding=0)

        self.rdb5 = RDB(self.numofkernels, nDenselayer=self.nDenselayer, growthRate=self.numofkernels)
        self.rdb6 = RDB(self.numofkernels, nDenselayer=self.nDenselayer, growthRate=self.numofkernels)
        self.rdb7 = RDB(self.numofkernels, nDenselayer=self.nDenselayer, growthRate=self.numofkernels)
        self.rdb8 = RDB(self.numofkernels, nDenselayer=self.nDenselayer, growthRate=self.numofkernels)
        self.oneone2 = nn.Conv2d(self.numofkernels * self.numforrg, self.numofkernels, kernel_size=1, stride=1, padding=0)

        self.rdb9 = RDB(self.numofkernels, nDenselayer=self.nDenselayer, growthRate=self.numofkernels)
        self.rdb10 = RDB(self.numofkernels, nDenselayer=self.nDenselayer, growthRate=self.numofkernels)
        self.rdb11 = RDB(self.numofkernels, nDenselayer=self.nDenselayer, growthRate=self.numofkernels)
        self.rdb12 = RDB(self.numofkernels, nDenselayer=self.nDenselayer, growthRate=self.numofkernels)
        self.oneone3 = nn.Conv2d(self.numofkernels * self.numforrg, self.numofkernels, kernel_size=1, stride=1, padding=0)

        self.rdb13 = RDB(self.numofkernels, nDenselayer=self.nDenselayer, growthRate=self.numofkernels)
        self.rdb14 = RDB(self.numofkernels, nDenselayer=self.nDenselayer, growthRate=self.numofkernels)
        self.rdb15 = RDB(self.numofkernels, nDenselayer=self.nDenselayer, growthRate=self.numofkernels)
        self.rdb16 = RDB(self.numofkernels, nDenselayer=self.nDenselayer, growthRate=self.numofkernels)
        self.oneone4 = nn.Conv2d(self.numofkernels * self.numforrg, self.numofkernels, kernel_size=1, stride=1, padding=0)
...
class Generator_one2many_gd_rir_cbam5_relu(nn.Module):
    def __init__(self, input_channel, numforrg, numofrdb):
        super(Generator_one2many_gd_rir_cbam5_relu, self).__init__()
...
class Generator_one2many_gd_rir_cbam5_no_relu(nn.Module):
    def __init__(self, input_channel, numforrg, numofrdb):
        super(Generator_one2many_gd_rir_cbam5_no_relu, self).__init__()
