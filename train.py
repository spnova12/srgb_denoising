...
from models.hevcNet import Generator_one2many_gd_rir_cbam3_non_recursive_relu
...
class TrainModule(object):
    def __init__(self):
        ...
        # 모델 생성 및 초기화.
        self.net = Generator_one2many_gd_rir_cbam3_non_recursive_relu(input_channel=3, numforrg=4, numofrdb=16).to(self.device)
