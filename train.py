...
from models.hevcNet import Generator_one2many_RDB_cbam_ver3
...
class TrainModule(object):
    def __init__(self):
        ...
        # 실험 이름.
        self.exp_name = 'exp014_hevc_cbam_ver3'
        ...
        # 모델 생성 및 초기화.
        self.net = Generator_one2many_RDB_cbam_ver3(input_channel=3).to(self.device)
