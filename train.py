...
from models.hevcNet import Generator_one2many_gd_rir_new
...
class TrainModule(object):
    def __init__(self):
        ...
        # 실험 이름.
        self.exp_name = 'exp014_hevc_gd_rir_new_code_new_param'
        ...
        # 모델 생성 및 초기화.
        self.net = Generator_one2many_gd_rir_new(input_channel=3, numforrg=4, numofrdb=120, numofconv=8, numoffilters=64).to(self.device)
