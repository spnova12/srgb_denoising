...
from models.hevcNet import Generator_one2many_gd_rir_cbam5_relu
...
class TrainModule(object):
    def __init__(self):
        ...
        # 실험 이름.
        self.exp_name = 'exp014_hevc_gd_rir_cbam5_relu'
        ...
        # 모델 생성 및 초기화.
        self.net = Generator_one2many_gd_rir_cbam5_relu(input_channel=3, numforrg=4, numofrdb=16).to(self.device)
